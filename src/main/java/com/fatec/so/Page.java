...
public class Page {
   ...
   public int pageType() {
      if (isClean && isReferenced)
         return CLEAN_REFERENCED;
      else if (isClean && !isReferenced)
         return CLEAN_UNREFERENCED;
      else if (!isClean && isReferenced)
         return DIRTY_REFERENCED;
      else if (!isClean && !isReferenced)
         return DIRTY_UNREFERENCED;
      return -1;
   }

   @Override public String toString() {
      return "" + frameNumber + " | " + isClean + " | " + isReferenced;
   }
}
